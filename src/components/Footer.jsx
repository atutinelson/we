...
const Footer = () => {
  const footerLinks = {
    ...
    contact: [
      { name: '+254791315487', href: '#' },
      { name: 'afritech@gmail.com', href: '#' },
    ],
  }
      ...
      <div className="section-container">
        ...
        >
          ...
          >
            ...
            >
              ...
              <span className="text-xl font-medium ml-1">AFRITECH INTERNATIONAL</span>
            </motion.div>
            <motion.p 
              variants={fadeIn('up', 0.6)}
              className="text-gray-600 mb-6"
            >
              We are a team of passionate developers, designers, and strategists committed to building high-quality software that drives business success. From web and mobile apps to enterprise solutions,
               we bring your ideas to life with innovation, transparency, and reliable delivery.
            </motion.p>
            <motion.div 
        ...
        >
          ...
          >
            ...
            >
              Copyright © {new Date().getFullYear()} Afritech solutions
            </motion.p>
